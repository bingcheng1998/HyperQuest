...
var hidden_size = [3, 5, 10, 50, 150]
var batch_size = [10, 50, 100, 200, 400]
var learning_rate = [4e-3, 3e-3, 1e-3, 5e-4, 1e-4]
var regularization = [0, 0.1, 0.5, 1, 10]
...
var innerHTML = generateFrom(hidden_size, 'hidden_size', 'hidden_size')
...
function submitForm() {
    ...
    var hidden_size =  findSelection("hidden_size");
    var batch_size =  findSelection("batch_size");
    var learning_rate =  findSelection("learning_rate");
    var regularization =  findSelection("regularization");
    var num_epoch = 8;
